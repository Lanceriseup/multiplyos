...
//
// A pointer performs a three-act tour on a loop, at 1x pacing:
...
const BOARDS: Board[] = [
  ...
  },
  {
    ...
    rows: [
      { name: "Landing Page Visitors", goal: "2,400", gv: 2400, unit: "int", hist: [2380, 1980, 2510, 2240, 2450, 2160], prev: 2180, cur: 2615 },
      { name: "New Leads", goal: "120", gv: 120, unit: "int", hist: [118, 94, 131, 110, 124, 105], prev: 108, cur: 134 },
      { name: "Email Open Rate", goal: "35%", gv: 35, unit: "pct", hist: [36, 29, 38, 33, 37, 32], prev: 33, cur: 41 },
      { name: "Cost per Lead", goal: "$18", gv: 18, unit: "usd", lower: true, hist: [19, 24, 17, 21, 16, 23], prev: 23, cur: 21 },
      { name: "Social Followers", goal: "8,500", gv: 8500, unit: "int", hist: [8240, 8090, 8460, 8310, 8520, 8180], prev: 8210, cur: 8740 },
    ],
  },
  {
    ...
    rows: [
      { name: "Revenue", goal: "$50,000", gv: 50, unit: "usdk", hist: [47.1, 39.8, 51.2, 45.6, 49.3, 43.7], prev: 47.2, cur: 51.4 },
      { name: "Cash Balance", goal: "$100,000", gv: 100, unit: "usdk", hist: [97.4, 88.6, 103.1, 96.8, 101.2, 94.5], prev: 96.4, cur: 108.9 },
      { name: "Accounts Receivable", goal: "$12,000", gv: 12, unit: "usdk", lower: true, hist: [13.4, 16.1, 11.8, 14.2, 12.6, 15.7], prev: 14.8, cur: 11.2 },
      { name: "Gross Margin", goal: "62%", gv: 62, unit: "pct", hist: [61, 54, 64, 59, 63, 56], prev: 58, cur: 64 },
  ...
  },
  {
    ...
    group: "Delivery",
    rows: [
      { name: "Tasks completed", goal: "25", gv: 25, unit: "int", hist: [24, 19, 27, 23, 26, 22], prev: 22, cur: 28 },
      { name: "Avg response time", goal: "4h", gv: 4, unit: "hours", lower: true, hist: [4.2, 5.1, 3.9, 4.4, 4.0, 4.7], prev: 4.9, cur: 3.2 },
      { name: "SOPs published", goal: "3", gv: 3, unit: "int", hist: [3, 1, 4, 2, 3, 2], prev: 2, cur: 4 },
      { name: "Rank Ups", goal: "3", gv: 3, unit: "int", hist: [4, 1, 5, 3, 4, 2], prev: 4, cur: 6 },
    ],
  },
];
...
const STILL: Scene = { ...BLANK, board: 2, extra: { name: NEW_METRIC, goal: NEW_GOAL } };
              ...
              >
                ...
                {scene.extra && (
                  <>
                    ...
                    <div className={`flex items-center justify-center border-b border-[#F1EEE9] px-1 py-[9px] ${scene.flash ? "tour-landed" : ""}`}>
                      <span className="grid h-[19px] w-[19px] place-items-center rounded-[5px] bg-gradient-to-br from-[#F49230] to-[#D8563F] text-[8px] font-bold text-white">SL</span>
                    </div>
...
function MetricRow({
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center border-b border-[#F1EEE9] px-1 py-[9px]">
        <span className="grid h-[19px] w-[19px] place-items-center rounded-[5px] bg-gradient-to-br from-[#F49230] to-[#D8563F] text-[8px] font-bold text-white">
          SL
        </span>
      </div>
      <div className="flex items-center justify-center border-b border-l border-[#ECEAE6] px-1 py-[9px]">
